...
module Sinatra
  module ImageHelper
    ...
    def add_logo(user_img, color_scheme)
      ...
      changebrazil_img = MiniMagick::Image.open(banner_path)
      resize_banner(user_img, changebrazil_img, banner_path)

      result = user_img.composite(changebrazil_img) do |c|
    ...
    def logo_in(color_scheme)
      "static/images/banners/#{color_scheme}.jpg"
    end
